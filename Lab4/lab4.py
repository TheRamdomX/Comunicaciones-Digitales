...
class lab4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._EbN0_range = qtgui.Range(0, 10, 1, 0, 200)
        self._EbN0_win = qtgui.RangeWidget(self._EbN0_range, self.set_EbN0, "Energy Bit / Noise Power", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.fec_ber_bf_0 = fec.ber_bf(False, 100, -7)
        ...
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0,  const[const_type].arity(),  int(10e6)))), False)
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.fec_ber_bf_0, 0))
    ...
    def set_const_type(self, const_type):
        ...
        self.digital_constellation_decoder_cb_0.set_constellation(self.const[self.const_type].base())
